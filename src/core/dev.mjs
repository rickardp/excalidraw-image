...
// from a WOFF2 blob generated by build.rs from the font sub-crates.
//
// Reads from the pre-generated WOFF2 blob when available for a fast Deno path.
// Falls back to re-encoding from .ttf.br via wawoff2 if the blob hasn't been
// built yet.
{
